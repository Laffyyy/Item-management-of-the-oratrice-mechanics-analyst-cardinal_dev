...
Partial Class frmProductEntry
    ...
    Private Sub InitializeComponent()
        ...
        ' lblProductName
        ' 
        lblProductName.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        ' lblProductPrice
        ' 
        lblProductPrice.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        lblProductPrice.Size = New Size(71, 17)
        lblProductPrice.TabIndex = 1
        lblProductPrice.Text = "ProductPrice"
        ' 
        ' lnlPanel
        ' 
        lnlPanel.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        lnlPanel.Size = New Size(107, 17)
        lnlPanel.TabIndex = 1
        lnlPanel.Text = "Product description"
        ' 
        ' Guna2TextBox1
        ' 
        Guna2TextBox1.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        Guna2TextBox1.Location = New Point(147, 75)
        ...
        ' Guna2TextBox2
        ' 
        Guna2TextBox2.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        Guna2TextBox2.Location = New Point(147, 157)
        ...
        ' Guna2TextBox3
        ' 
        Guna2TextBox3.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
